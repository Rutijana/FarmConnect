  ...
  return (
    <nav style={{ background: '#1A7A3C', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '60px', boxShadow: '0 2px 8px rgba(0,0,0,0.15)' }}>
      ...
      <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
        <Link to="/dashboard" style={{ color: '#A8E6BF', textDecoration: 'none', fontSize: '15px' }}>My Listings</Link>
        <Link to="/orders" style={{ color: '#A8E6BF', textDecoration: 'none', fontSize: '15px' }}>My Orders</Link>
        <Link to="/create" style={{ color: '#A8E6BF', textDecoration: 'none', fontSize: '15px' }}>+ New Listing</Link>
